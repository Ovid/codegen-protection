...
#<<< CodeGen::Protection::Type::Perl 0.01. Do not touch any code between this and the end comment. Checksum: aa97a021bd70bf3b9fa3e52f203f2660
...
throws_ok {
    CodeGen::Protection::Type::Perl->new(
...
#>>> CodeGen::Protection::Type::Perl 0.01. Do not touch any code between this and the start comment. Checksum: aa97a021bd70bf3b9fa3e52f203f2660
...
my $rewrite;
lives_ok {
    $rewrite = CodeGen::Protection::Type::Perl->new(
        existing_code => $existing_code,
        injected_code => $injected_code,
        overwrite     => 1,
    )
...
#<<< CodeGen::Protection::Type::Perl 0.01. Do not touch any code between this and the end comment. Checksum: df10700d59c3058bb3cf2d1c06169063

my $injected_code = foo();

#>>> CodeGen::Protection::Type::Perl 0.01. Do not touch any code between this and the start comment. Checksum: df10700d59c3058bb3cf2d1c06169063
